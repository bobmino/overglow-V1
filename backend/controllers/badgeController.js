...
const getOperatorBadges = async (req, res) => {
  try {
    ...
    logger.error('Get operator badges error:', error);
...
const getProductBadges = async (req, res) => {
  try {
    ...
    logger.error('Get product badges error:', error);
...
const updateOperatorBadges = async (req, res) => {
  try {
    ...
    logger.error('Update operator badges error:', error);
...
const updateProductBadges = async (req, res) => {
  try {
    ...
    logger.error('Update product badges error:', error);
