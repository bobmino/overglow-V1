  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden bg-slate-200">
        ...
        />
        {post.featured && (
          <div className="absolute top-4 start-4 bg-primary-600 text-white px-3 py-1 rounded-full text-xs font-bold">
            À la une
          </div>
        )}
        <div className="absolute top-4 end-4 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg text-xs font-semibold text-slate-700">
          {post.category}
        </div>
      </div>
