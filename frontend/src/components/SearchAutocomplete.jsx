  ...
  return (
    <div className="relative w-full" ref={autocompleteRef}>
      ...
      {isOpen && (hasSuggestions || suggestions?.showNearby) && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-slate-100 py-2 z-[999] max-h-[400px] overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Nearby Option */}
